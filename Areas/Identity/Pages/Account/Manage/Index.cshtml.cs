...
namespace MoustacheApp.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var altName = user.AltName;
            // GetRolesAsync returns a list of roles, but we only allow one
            var roles = await _userManager.GetRolesAsync(user);
            var email = await _userManager.GetEmailAsync(user);
            var phoneNumber = await _userManager.GetPhoneNumberAsync(user);

            UserName = userName;
            Name = roles[0];        // get 'first' role
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.AltName != user.AltName) user.AltName = Input.AltName;
